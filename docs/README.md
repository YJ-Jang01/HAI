...
This directory keeps only the active project docs needed for development.
...
- `archive/Proposal-1.md`: original proposal kept for reference only.
...
Keep docs small and useful. If a note does not help development, implementation, or the user study, do not add a new document for it.
