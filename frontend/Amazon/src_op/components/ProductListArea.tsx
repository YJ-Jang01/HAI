...
import { SlidersHorizontal, RefreshCw, Check } from 'lucide-react';
            ...
            <div>
              ...
              <ul className="space-y-1 text-xs">
                <li
                  ...
                  className={`py-1.5 px-2.5 rounded-sm cursor-pointer hover:bg-gray-100 transition-colors ${filterState.origin === 'All' ? 'font-bold text-[#C7511F]' : 'text-gray-700'}`}
                >
                  All Origins
                </li>
                {origins.map(ori => (
                  <li
                    ...
                    className={`py-1.5 px-2.5 rounded-sm cursor-pointer hover:bg-gray-100 transition-all flex items-center gap-2 ${filterState.origin === ori ? 'font-bold text-[#C7511F]' : 'text-gray-700'}`}
                  >
                    <span>{getOriginIcon(ori)}</span>
                    <span>{ori}</span>
                  </li>
                ))}
              </ul>
